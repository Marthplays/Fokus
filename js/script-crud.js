...
const buttonRemoverTodas = document.querySelector('#btn-remover-todas')
...
function criarElementoTarefa(tarefa) {
    ...
    imagemButton.src = '/imagens/edit.png'
...
buttonRemoverConcluidas.onclick = () => removerTarefas(true);
buttonRemoverTodas.onclick = () => removerTarefas(false);